...
class MyApp:
    def __init__(self, root):
        ...
        self.inputFrame = Frame(self.root, width=340, height=50, bd=0, highlightbackground="white", highlightcolor="gray", highlightthickness=2)
        self.inputFrame.pack(padx=420, pady=123)
        ...
        self.angleFrame.place(x=540, y=210)
        ...
        self.create_button_7(text='AC', x=470, y=243, command=lambda: self.clearAll())
        self.create_button_7(text='=', x=470, y=334, command=lambda: self.equalTo())
        self.create_button(text='Bloch', x=1100, y=243, command=lambda: self.plotBlochSphere())
        self.create_button(text='BarP', x=1100, y=334, command=lambda: self.plotBarGraph())  # New button for bar graph
